...
| --------------------------- | ------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`<xsl:template>`**        | Define una plantilla con patrones de coincidencia | `<xsl:template                                                                                                                                                                                                                                            |
| **`<xsl:apply-templates>`** | Aplica plantillas a los nodos hijos               |                                                                                                                                                                                                                                                           |
| **`<xsl:value-of>`**        | Extra                                                                                                                                                                                                                                                                                                         |
| **`<xsl:for-each>`**        | Bucle sobre un conjunt                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              `<xsl:sort select="nombre" data-type="text" order="ascending"/>`  <br>`<xsl:sort select="nombre" data-type="number" order="descending"/>`<br>`order=(por-defecto:ascending o descending)` <br>`data-type=(por-defecto:text o number)` nding)`  nding)`  nding)`  nding)`  nding)`  nding)`  nding)`  nding)`  nding)`  nding)`  nding)`  nding)`  nding)`  nding)`  nding)`  nd                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
